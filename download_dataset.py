...
parser.add_argument('datasets', metavar='N', type=str, nargs='+', choices=['celebA', 'lsun', 'mnist', 'f-mnist', 'cifar-10'],
                    help='name of dataset to download [celebA, lsun, mnist, f-mnist, cifar-10]')
